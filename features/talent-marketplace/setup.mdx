...
* <span style={{ color: '#ef4444' }}>**Incorrect:**</span> <code>JobTech Singapore > Product</code> (Because "Product" is already a child of a different (L1/entity). Refer to point no 1)
* <span style={{ color: '#16a34a' }}>**Correct:**</span> <code>JobTech Singapore > Product (SG) > TalentTrack+ (SG) > Product Development (SG) > Project Manager (L5) > Senior Manager (L7)</code>
